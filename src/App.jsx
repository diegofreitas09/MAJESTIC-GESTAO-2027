...
function App(){
 ...
 {pagina==='interessados'&&<ClientesExecutivo dados={interessados} modo="interessados"/>}{pagina==='atendimentos'&&<AtendimentosExecutivo dados={atendimentos}/>} {pagina==='gestao-sucesso'&&<GestaoSucesso initialMode="direcao" lockMode/>}{pagina==='matriculas'&&<ClientesExecutivo dados={matriculas} modo="matriculas"/>}{pagina==='produtos'&&<ProdutosValores/>}{pagina==='direcao'&&<Lista titulo="Central da Direção" subtitulo="Perguntas, orientações e decisões oficiais" dados={perguntas} vazio="Nenhuma pergunta registrada."/>}</main></div>}
export default App;