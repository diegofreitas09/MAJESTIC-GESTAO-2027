...
import AtendentesAdmin from './AtendentesAdmin';
import Alunos2027 from './Alunos2027';
...
const MENU=[['dashboard','Dashboard',LayoutDashboard],['interessados','Procuras e interessados',Users],['atendimentos','Atendimentos',GraduationCap],['equipe-atendimento','Equipe de Atendimento',Users],['gestao-sucesso','Gestão de Sucesso',Handshake],['matriculas','Matrículas',UserPlus],['alunos-2027','Alunos 2027',GraduationCap],['produtos','Produtos e valores',Package],['direcao','Central da Direção',MessageCircleQuestion]];
...
function App(){
 ...
 {pagina==='interessados'&&<ClientesExecutivo dados={interessados} modo="interessados"/>}{pagina==='atendimentos'&&<AtendimentosExecutivo dados={atendimentos}/>} {pagina==='equipe-atendimento'&&<AtendentesAdmin/>}{pagina==='gestao-sucesso'&&<GestaoSucesso initialMode="direcao" lockMode/>}{pagina==='matriculas'&&<ClientesExecutivo dados={matriculas} modo="matriculas"/>}{pagina==='alunos-2027'&&<Alunos2027/>}{pagina==='produtos'&&<ProdutosValores/>}{pagina==='direcao'&&<Lista titulo="Central da Direção" subtitulo="Perguntas, orientações e decisões oficiais" dados={perguntas} vazio="Nenhuma pergunta registrada."/>}</main></div>}
export default App;